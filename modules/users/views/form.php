                    ...
                    <div id="administrator_fields">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="user_cod_interscambio">
                                        Codice Interscambio
                                    </label>
                                    <input type="text" maxlength="7" name="user_cod_interscambio" id="user_cod_interscambio" class="form-control"
                                           value="<?php echo $this->mdl_users->form_value('user_cod_interscambio', true); ?>">
                                </div>
