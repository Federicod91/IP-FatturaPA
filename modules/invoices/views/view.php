    ...
    $(function () {
        ...
        $('#btn_save_invoice').click(function () {
            ...
            $.post("<?php echo site_url('invoices/ajax/save'); ?>", {
				    ...
				    invoice_importo_bollo: $('#invoice_importo_bollo').val(),
				    invoice_asolvimento_bollo: $('#invoice_asolvimento_bollo').val(),
                },
                function (data) {
    ...
    <div class="headerbar-item pull-right <?php if ($invoice->is_read_only != 1 || $invoice->invoice_status_id != 4) { ?>btn-group<?php } ?>">
        ...
        <div class="options btn-group btn-group-sm">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    <a href="<?php echo site_url('invoices/downloadXml/'.$invoice->invoice_id); ?>">
                        <i class="fa fa-file-text"></i> Scarica xml
                    </a>
                </li>
                <li class="divider"></li>
                <li>
