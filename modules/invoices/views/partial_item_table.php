...
<div class="row">
    ...
    <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4">
        <table class="table table-bordered text-right">
			...
			<tr>
				<td class="td-vert-middle">Bollo Virtuale</td>
                <td class="clearfix">
                        <div class="input-group input-group-sm">
							<select id="invoice_asolvimento_bollo" type="text" name="invoice_asolvimento_bollo" class="form-control input-sm amount"
                                   value="<?php echo $invoice->invoice_asolvimento_bollo; ?>"
                                <?php if ($invoice->is_read_only == 1) {
                                    echo 'disabled="disabled"';
                                } ?>
								>
								<option value="no">Esente</option>
                                <option value="si">Non Esente</option>
							</select>	
                        </div>
				</td>
			</tr>
			<tr>
				<td class="td-vert-middle">Importo Bollo</td>
                <td class="clearfix">
                        <div class="input-group input-group-sm">
                            <input id="invoice_importo_bollo" type="text" name="invoice_importo_bollo" class="form-control input-sm amount"
								   value="<?php echo $invoice->invoice_importo_bollo; ?>"
                                <?php if ($invoice->is_read_only == 1) {
                                    echo 'disabled="disabled"';
                                } ?>
                                   >
