...
class Mdl_Invoices extends Response_Model
{
    ...
    public function validation_rules()
    {
        return array(
	        ...
	        'invoice_importo_bollo' => array(
                'field' => 'invoice_importo_bollo',
                'label' => trans('iImporto Bollo')
            ),

	        'invoice_asolvimento_bollo' => array(
                'field' => 'invoice_asolvimento_bollo',
                'label' => trans('Assolvimento Bollo')
            ),
