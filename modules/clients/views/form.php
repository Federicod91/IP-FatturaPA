            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="client_cod_interscambio">Codice Interscambio</label>

                            <div class="controls">
                                <input type="text" maxlength="7" name="client_cod_interscambio" id="client_cod_interscambio" class="form-control"
                                       value="<?php echo $this->mdl_clients->form_value('client_cod_interscambio', true); ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="client_pec">Indirizzo Pec</label>

                            <div class="controls">
                                <input type="email" name="client_pec" id="client_pec" class="form-control"
                                       value="<?php echo $this->mdl_clients->form_value('client_pec', true); ?>">
                            </div>
                        </div>
